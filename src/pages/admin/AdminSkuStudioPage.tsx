    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="px-4 py-4 space-y-4">
      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="rounded-lg p-2.5 text-center" style={{ backgroundColor: 'var(--color-surface)' }}>
          <p className="text-xs" style={{ color: 'var(--color-text-tertiary)' }}>총 세션</p>
          <p className="text-sm font-bold text-txt mt-0.5">{allSessions.length.toLocaleString()}</p>
        </div>
        <div className="rounded-lg p-2.5 text-center" style={{ backgroundColor: 'var(--color-surface)' }}>
          <p className="text-xs" style={{ color: 'var(--color-text-tertiary)' }}>MVP SKU</p>
          <p className="text-sm font-bold text-txt mt-0.5">{studioEntries.length}개</p>
        </div>
        <div className="rounded-lg p-2.5 text-center" style={{ backgroundColor: 'var(--color-surface)' }}>
          <p className="text-xs" style={{ color: 'var(--color-text-tertiary)' }}>총 매칭</p>
          <p className="text-sm font-bold text-txt mt-0.5">{totalMatching.toLocaleString()}</p>
        </div>
      </div>
